export default {
  ...
  traceroute: {
    ...
    maxHops: 'Max Hops',
    tcpPort: 'TCP Port',
    expandIps: 'Expand to show {count} IPs breakdown',
    collapseIps: 'Collapse IP breakdown',
  ...
  alerts: {
    title: 'Alerts',
    subtitle: 'Manage alert rules and view recent events',
    rules: 'Alert Rules',
    addRule: 'New Rule',
    cancel: 'Cancel',
    save: 'Save',
    ruleName: 'Rule Name',
    ruleNamePlaceholder: 'e.g., High Latency Alert',
    target: 'Target',
    conditionType: 'Condition Type',
    threshold: 'Threshold',
    duration: 'Consecutive Count',
    notifyWays: 'Notification',
    ...
    latencyGt: 'Latency >',
    lossGt: 'Loss rate >',
    timeoutStreak: 'Timeout streak',
    pathChange: 'Path change',
    cond: {
      latency: 'Latency',
      loss: 'Loss Rate',
      timeout_streak: 'Timeout Streak',
